...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(5,5,1,128, 'single'), zeros(1, 128, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'name', 'conv1') ;                                              
                           ... %% first layer
...
% Supplement code here
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(3,3,1,512, 'single'), zeros(1, 512, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'name', 'conv2') ;                       
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(9,9,512,15, 'single'), zeros(1, 15, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'name', 'fc1') ;
