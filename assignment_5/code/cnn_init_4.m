...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(3,3,1,128, 'single'), zeros(1, 128, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'name', 'conv1') ;
                           ... %% first layer
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(9,9,128,800, 'single'), zeros(1, 800, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'name', 'fc1') ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(1,1,800,15, 'single'), zeros(1, 15, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'name', 'fc1') ;
